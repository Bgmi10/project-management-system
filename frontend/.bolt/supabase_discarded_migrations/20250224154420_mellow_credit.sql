/*
  # Task Creation Schema Update

  1. Changes
    - Adds basic task fields (title, description, status, priority)
    - Adds project reference and user assignments
    - Adds basic task tracking fields (created_at, updated_at)
...
-- Add basic task fields to tasks table
ALTER TABLE tasks
